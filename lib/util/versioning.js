...
module.exports.evaluate = function(package_json,options,callback) {
    ...
    opts.host = eval_template(package_json.binary.host,opts);
    opts.module_path = path.resolve(eval_template(package_json.binary.module_path,opts));
    opts.remote_path = package_json.binary.remote_path ? eval_template(package_json.binary.remote_path,opts) : '';
    opts.package_name = eval_template(package_json.binary.package_name,opts);
    ...
    opts.hosted_path = url.resolve(base,opts.remote_path);
