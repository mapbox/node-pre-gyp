...
module.exports.eval_template = eval_template;
...
var default_package_name = module.exports.default_package_name = '{module_name}-v{version}-{node_abi}-{platform}-{arch}.tar.gz';
